<?php
    ...
    class SecretariasC {
        ...
        /* Ingreso Secretarias */
        /* Recibe Usuario y Contraseña del Login para verificar si coninciden con los datos de la Base de Datos
        si son correctos crea las variables de sesión del usuario y nos manda a la vista inicio.  */
            ...
            if (isset($_POST["usuario-Ing"])) {
                ...
                if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["usuario-Ing"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["clave-Ing"])) {
                    ...
                    if ($resultado["usuario"] == $_POST["usuario-Ing"] && $resultado["clave"] == $_POST["clave-Ing"]) {
                        ...
                        echo '<div class="alert alert-danger" style="margin-top: 10px;">Error al Ingresar</div>'; 
